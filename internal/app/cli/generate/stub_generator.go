...
func main() {
	...
	directories := []string{"cmd/mashling-gateway", "internal/app/gateway", "internal/app/version", "internal/app/assets", "internal/pkg", "pkg", "scripts", "vendor", "dockerfiles", "ext", "lib"}
	topLevelFiles := []string{"Gopkg.lock", "Gopkg.toml", "build.go"}
