...
func vendorGithubComTibcosoftwareFlogoContribActionFlowActionJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "vendor/github.com/TIBCOSoftware/flogo-contrib/action/flow/action.json", size: 302, mode: os.FileMode(420), modTime: time.Unix(1522431985, 0)}
