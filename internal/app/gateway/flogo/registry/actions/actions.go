...
func pkgFlogoActionActionJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "pkg/flogo/action/action.json", size: 361, mode: os.FileMode(436), modTime: time.Unix(1536041955, 0)}
...
func vendorGithubComTibcosoftwareFlogoContribActionFlowActionJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "vendor/github.com/TIBCOSoftware/flogo-contrib/action/flow/action.json", size: 302, mode: os.FileMode(436), modTime: time.Unix(1535605435, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
