...
func extFlogoTriggerGrpcTriggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "ext/flogo/trigger/grpc/trigger.json", size: 1236, mode: os.FileMode(420), modTime: time.Unix(1535533841, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func extFlogoTriggerWssubTriggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "ext/flogo/trigger/wssub/trigger.json", size: 492, mode: os.FileMode(493), modTime: time.Unix(1534860187, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
