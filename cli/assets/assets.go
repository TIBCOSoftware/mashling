...
func assetsBannerTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/banner.txt", size: 2481, mode: os.FileMode(438), modTime: time.Unix(1519724406, 0)}
...
func assetsDefgopkgLock() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/defGopkg.lock", size: 7749, mode: os.FileMode(438), modTime: time.Unix(1519896558, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsDefgopkgToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/defGopkg.toml", size: 683, mode: os.FileMode(438), modTime: time.Unix(1519896547, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func schemaMashling_schema02Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/mashling_schema-0.2.json", size: 6575, mode: os.FileMode(438), modTime: time.Unix(1519724406, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
