...
Ping functionality can be enabled or disabled setting environment variable 'MASHLING_PING_ENABLE' value to TRUE or FALSE. By default ping functionality is enabled.
