...
Ping functionality can be enabled or disabled setting environment variable 'MASHLING_PING_DISABLE' value to TRUE or FALSE. By default ping functionality is enabled.
